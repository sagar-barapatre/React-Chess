    ...
    <div className={classes.root}>
      ...
      >
        <Paper className={classes.title}>
          <Typography variant="h1">Chess</Typography>
        </Paper>
      </motion.div>
      ...
      >
        ...
        <DialogContent>
          ...
          <DialogActions>
            <Button
              onClick={continueDialog?.handleContinueClick}
              color="primary"
            >
              Continue
            </Button>
            <Button
              onClick={continueDialog?.handleNewGameClick}
              color="primary"
            >
              Create New Game
            </Button>
      ...
      <Dialog onClose={() => setAboutDialogOpen(false)} open={aboutDialogOpen}>
        ...
        <DialogContent>
          <DialogContentText>
            Hi, I'm Sagar Barapatre and I created this chess app.
          </DialogContentText>
          <DialogActions>
            <Button
              color="primary"
              endIcon={<GitHubIcon />}
              href="https://github.com/sagar-barapatre"
              target="_blank"
            >
              Checkout My Github
            </Button>
